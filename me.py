...
class GUI(tk.Tk):
    ...
    def create_widgets(self):
        ...
        tk.Label(self, text="Insert new flight details", font=("Helvetica", 10)).grid(row=4, column=1, pady=10)
        ...
        tk.Label(self, text="Insert new passenger details", font=("Helvetica", 10)).grid(row=5, column=1, pady=10)
